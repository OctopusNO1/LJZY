...
namespace LJZY.COMMON
{
	...
	public static partial class Extensions
	{
		...
		//{
		//	return Convert.ToIntOrNull(data);
		//}
		...
		//{
		//	return Convert.ToDoubleOrNull(data);
		//}
		...
		//{
		//	return Convert.ToDecimalOrNull(data);
		//}
		...
		//{
		//	return Convert.ToDateOrNull(data);
		//}
		...
		//{
		//	return Convert.ToGuidOrNull(data);
		//}
		...
		//{
		//	return Convert.ToGuidList(data);
		//}
