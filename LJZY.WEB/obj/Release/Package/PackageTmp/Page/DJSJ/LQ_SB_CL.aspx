<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LQ_SB_CL.aspx.cs" Inherits="LJZY.WEB.Page.DJSJ.LQ_SB_CL" %>
        ...
        <div class="search_div">
            <div style="height:4px"></div>
                ...
                <input id="SelectColumn_List" class="easyui-combobox" style="width:150px" panelHeight="auto" data-options="
                            url:'../../Controllers/ColumnListController.ashx?action=CL_ZD',
					        method:'post',
					        valueField:'CODE',
					        textField:'NAME',
                            editable:false,
...
<div id="dlg" class="easyui-dialog" title="Basic Dialog" data-options="iconCls:'icon-save',toolbar: [{
            ...
            $(this).find('input').prop('checked', !$(this).find('input').prop('checked'));
            	...
            	<ul style="list-style:none;padding:0;margin:0">
                    ...
                    <li><input type="checkbox" value="CCRQ_GD" /><span>出厂日期</span></li>
                    <li><input type="checkbox" value="CCBH" /><span>出厂编号</span></li>
                    <li><input type="checkbox" value="TCRQ_GD" /><span>投产日期</span></li>
                    <li><input type="checkbox" value="ZJNX" /><span>折旧年限</span></li>
                    <li><input type="checkbox" value="RLFL" /><span>燃料分类</span></li>
                    <li><input type="checkbox" value="SBZK" /><span>设备状况</span></li>
                    <li><input type="checkbox" value="SBSZWZ" /><span>使用地点</span></li>
                    <li><input type="checkbox" value="DXQK" /><span>大修情况</span></li>
...
<script src="../../Scripts/LQZY/LQ_SB_CL.js"></script>
