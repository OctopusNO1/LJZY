<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LQ_SB_GCCSY.aspx.cs" Inherits="LJZY.WEB.Page.DJSJ.LQ_SB_GCCSY" %>
        ...
        <div class="search_div">
            <div style="height:4px"></div>
                ...
                <input id="SelectColumn_List" class="easyui-combobox" style="width:150px" panelHeight="auto" data-options="
                            url:'../../Controllers/ColumnListController.ashx?action=GCCSY_ZD',
					        method:'post',
					        valueField:'CODE',
					        textField:'NAME',
                            editable:false,
...
<script src="../../Scripts/LQZY/LQ_SB_GCCSY.js"></script>
