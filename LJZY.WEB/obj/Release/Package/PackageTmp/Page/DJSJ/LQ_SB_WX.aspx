<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LQ_SB_WX.aspx.cs" Inherits="LJZY.WEB.Page.DJSJ.LQ_SB_WX" %>
        ...
        <div class="search_div">
            <div style="height:4px"></div>
                ...
                <input id="SelectColumn_List" class="easyui-combobox" style="width:150px" panelHeight="auto" data-options="
                            url:'../../Controllers/ColumnListController.ashx?action=WX_ZD',
					        method:'post',
					        valueField:'CODE',
					        textField:'NAME',
                            editable:false,
...
<div id="dlg" class="easyui-dialog" title="Basic Dialog" data-options="iconCls:'icon-save',toolbar: [{
            ...
            $(this).find('input').prop('checked', !$(this).find('input').prop('checked'));
            	...
            	<ul style="list-style:none;padding:0;margin:0">
                        ...
                        <li><input type="checkbox" value="ZCBH" /><span>资产编号</span></li>
                        <li><input type="checkbox" value="ZBH" /><span>自编号</span></li>
...
<script src="../../Scripts/LQZY/LQ_SB_WX.js"></script>
