...
$(function () {
    ...
    //表格数据源
    $('#dg').datagrid({
        url: '../../Controllers/SBGLController.ashx?action=SB_GCCSYDataGrid',
        loadMsg: '数据加载中......',
        ...
        columns: [[
            ...
            { field: 'SSDW', title: '所属单位', align: 'center', width: 100 },
...
function insert_one() {
    ...
    //打开窗体
    $("#insert_dlg").dialog("open").dialog("setTitle", "工程参数仪信息导入");
...
function excelImport() {
    ...
    $('#jurSubsystemMenu').form('submit', {
        url: "../../Controllers/SBGLController.ashx?action=PreviewExcel_GCCSY",
        onSubmit: function () {
            return true;
        },
...
function openUrl() {
    if (rydata.length > 0) {
        $.ajax({
            type: "POST",
            url: '../../Controllers/SBGLController.ashx?action=ImportExcel_GCCSY',
...
function exportExcel() {
    ...
    $('#ExportIframe').attr("src", "../../../Page/DownLoad/DownLoad.aspx?Source=OutExportExcel_SBGCCSY&str=" + escape(str));
}
