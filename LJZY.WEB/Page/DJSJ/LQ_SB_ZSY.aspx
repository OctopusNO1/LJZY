<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LQ_SB_ZSY.aspx.cs" Inherits="LJZY.WEB.Page.DJSJ.LQ_SB_ZSY" %>
        ...
        <div class="search_div">
            <div style="height:4px"></div>
                ...
                <input id="SelectColumn_List" class="easyui-combobox" style="width:150px" panelHeight="auto" data-options="
                            url:'../../Controllers/ColumnListController.ashx?action=ZSY_ZD',
					        method:'post',
					        valueField:'CODE',
					        textField:'NAME',
                            editable:false,
...
<div id="dlg" class="easyui-dialog" title="Basic Dialog" data-options="iconCls:'icon-save',toolbar: [{
            ...
            $(this).find('input').prop('checked', !$(this).find('input').prop('checked'));
            	...
            	<ul style="list-style:none;padding:0;margin:0">
                        ...
                        <li><input type="checkbox" value="DW" /><span>所属单位</span></li>
                        <li><input type="checkbox" value="SBSZWZ" /><span>安装地点</span></li>
                        <li><input type="checkbox" value="DXSJ_GD" /><span>大修时间</span></li>
...
<script src="../../Scripts/LQZY/LQ_SB_ZSY.js"></script>
