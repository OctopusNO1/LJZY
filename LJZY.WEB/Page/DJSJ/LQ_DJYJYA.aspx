<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LQ_DJYJYA.aspx.cs" Inherits="LJZY.WEB.Page.DJSJ.LQ_DJYJYA" %>
    ...
    <div title="单井应急预案查询">   
        <div class="search_div" style="padding-left:5px">
            <div style="height:4px"></div>
                ...
                <button class="easyui-linkbutton btnGetType" id="daoru_one" onclick="insert()">导入</button>
        </div>
...
<script src="../../Scripts/LQZY/LQ_DJYJYA.js"></script>
