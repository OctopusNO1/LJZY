...
$(function () {
    ...
    //表格数据源
    $('#dg').datagrid({
        url: '../../Controllers/SBGLController.ashx?action=SB_CLDataGrid',
        loadMsg: '数据加载中......',
        ...
        columns: [[
            ...
            { field: 'ZJNX', title: '折旧年限', align: 'center', width: 100 },
            { field: 'RLFL', title: '燃料分类', align: 'center', width: 100 },
            { field: 'SBZK', title: '设备状况', align: 'center', width: 100 },
            { field: 'SBSZWZ', title: '使用地点', align: 'center', width: 100 },
            { field: 'DXQK', title: '大修情况', align: 'center', width: 100 },
...
function excelImport() {
    ...
    $('#jurSubsystemMenu').form('submit', {
        url: "../../Controllers/SBGLController.ashx?action=PreviewExcel_CL",
        onSubmit: function () {
            return true;
        },
...
function PreviewImport() {
    ...
    $('#girdPreview').datagrid({
        ...
        columns: [[
            ...
            { field: 'RLFL', title: '燃料分类', align: 'center', width: 100 },
            { field: 'SBZK', title: '设备状况', align: 'center', width: 100 },
            { field: 'SYDD', title: '使用地点', align: 'center', width: 100 },
            { field: 'DXQK', title: '大修情况', align: 'center', width: 100 },
            { field: 'BZ', title: '备注', align: 'center', width: 100 },
...
function openUrl() {
    if (rydata.length > 0) {
        $.ajax({
            type: "POST",
            url: '../../Controllers/SBGLController.ashx?action=ImportExcel_CL',
...
function exportExcel() {
    $('#ExportIframe').attr("src", "../../../Page/DownLoad/DownLoad.aspx?Source=OutExportExcel_SBCL&str=" + escape(str));
}
