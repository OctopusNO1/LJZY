...
$(function () {
    ...
    //表格数据源
    $('#dg').datagrid({
        url: '../../Controllers/SBGLController.ashx?action=LQ_FWDataGrid&fl=0',
        loadMsg: '数据加载中......',
        ...
        pageSize: 10,
        columns: [[
            //{ field: 'FL', title: '分类', align: 'center', width: 100 },
            ...
            { field: 'SBZK', title: '状况', align: 'center', width: 100 },
            { field: 'SBSZWZ', title: '所在位置', align: 'center', width: 100 },
...
function insert_one() {
    ...
    //打开窗体
    $("#insert_dlg").dialog("open").dialog("setTitle", "房屋信息导入");
...
function excelImport() {
    ...
    $('#jurSubsystemMenu').form('submit', {
        url: "../../Controllers/SBGLController.ashx?action=PreviewExcel_FW&fl=0",
        onSubmit: function () {
            return true;
        },
...
function PreviewImport() {
    ...
    $('#girdPreview').datagrid({
        ...
        columns: [[
            //{ field: 'FL', title: '分类', align: 'center', width: 100 },
            { field: 'LJFGS', title: '项目部', align: 'center', width: 100 },
            { field: 'CCBH', title: "编号", align: 'center', width: 100, },
            { field: 'GGXH', title: '型号', align: 'center', width: 100 },
            { field: 'SBZK', title: '状况', align: 'center', width: 100 },
            { field: 'SBSZWZ', title: '所在位置', align: 'center', width: 100 },
            { field: 'BZ', title: '备注', align: 'center', width: 100 }
...
function openUrl() {
    if (rydata.length > 0) {
        $.ajax({
            type: "POST",
            url: '../../Controllers/SBGLController.ashx?action=ImportExcel_FW&fl=0',
...
function exportExcel() {
    ...
    $('#ExportIframe').attr("src", "../../../Page/DownLoad/DownLoad.aspx?Source=OutExportExcel_FW&fl=0&str=" + str);
}
