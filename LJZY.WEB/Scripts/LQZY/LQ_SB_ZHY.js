...
$(function () {
    ...
    //表格数据源
    $('#dg').datagrid({
        url: '../../Controllers/SBGLController.ashx?action=SB_ZHYDataGrid',
        loadMsg: '数据加载中......',
        ...
        pageSize: 10,
        columns: [[
            { field: 'DW', title: '单位名称', align: 'center' },
            { field: 'SBMC', title: '设备名称', align: 'center'},
            { field: 'SSXD', title: '所属小队', align: 'center' },
            { field: 'ZZ', title: "资质", align: 'center' },
            { field: 'GGXH', title: '规格型号', align: 'center' },
            { field: 'SCCJ', title: '生产厂家', align: 'center' },
            { field: 'GB', title: '国别', align: 'center'},
            { field: 'CCRQ_GD', title: '出厂日期', align: 'center' },
            { field: 'CCBH', title: '出厂编号', align: 'center' },
            { field: 'TCRQ_GD', title: '投产日期', align: 'center' },
            { field: 'SBXBH', title: '设备现编号', align: 'center'},
            { field: 'SBZBH', title: '设备自编号', align: 'center'},
            { field: 'SP', title: '色谱型号', align: 'center' },
            { field: 'SPFXZQ', title: '色谱分析周期', align: 'center' },
            { field: 'SBZK', title: '设备状况', align: 'center' },
            { field: 'SSDW', title: '所属单位', align: 'center' },
            { field: 'SBSZWZ', title: '设备所在位置', align: 'center' },
            { field: 'DXSJ_GD', title: '大修时间', align: 'center'},
            { field: 'LHQTT', title: '硫化氢探头', align: 'center' },
            { field: 'LHQNJ', title: '硫化氢年检', align: 'center' },
            { field: 'QTBY', title: '气体标样', align: 'center' },
...
function insert_one() {
    ...
    //打开窗体
    $("#insert_dlg").dialog("open").dialog("setTitle", "综合仪(气测)设备信息导入");
...
function excelImport() {
    ...
    $('#jurSubsystemMenu').form('submit', {
        url: "../../Controllers/SBGLController.ashx?action=PreviewExcel_ZHY",
        onSubmit: function () {
            return true;
        },
...
function PreviewImport() {
    ...
    $('#girdPreview').datagrid({
        ...
        columns: [[
            ...
            { field: 'SSXD', title: '所属小队', align: 'center', width: 100 },
            { field: 'ZZ', title: "资质", align: 'center', width: 100, },
            { field: 'GG', title: '规格', align: 'center', width: 100 },
            { field: 'XH', title: '型号', align: 'center', width: 100 },
            ...
            { field: 'SBXBH', title: '设备现编号', align: 'center', width: 100 },
            { field: 'SBZBH', title: '设备自编号', align: 'center', width: 100 },
            { field: 'SP', title: '色谱型号', align: 'center', width: 100 },
            { field: 'SPFXZQ', title: '色谱分析周期', align: 'center', width: 100 },
            { field: 'SBZK', title: '设备状况', align: 'center', width: 100 },
            { field: 'DW', title: '所属单位', align: 'center', width: 100 },
            { field: 'SBSZWZ', title: '设备所在位置', align: 'center', width: 100 },
            { field: 'DXSJ_GD', title: '大修时间', align: 'center', width: 100 },
            { field: 'LHQTT', title: '硫化氢探头', align: 'center', width: 100 },
            { field: 'LHQNJ', title: '硫化氢年检', align: 'center', width: 100 },
            { field: 'QTBY', title: '气体标样', align: 'center', width: 100 },
...
function openUrl() {
    if (rydata.length > 0) {
        $.ajax({
            type: "POST",
            url: '../../Controllers/SBGLController.ashx?action=ImportExcel_ZHY',
...
function exportExcel() {
    ...
    $('#ExportIframe').attr("src", "../../../Page/DownLoad/DownLoad.aspx?Source=OutExportExcel_SBZHY&str=" + escape(str));
}
