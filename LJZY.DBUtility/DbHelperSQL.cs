...
namespace LJZY.DBUtility
{
    public abstract class DbHelperSQL
    {
        //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.		
        public static string connectionString = ConfigurationManager.ConnectionStrings["MMS"].ConnectionString;
        ...
        public static int ExecuteNonQuerySql(string conn, string SQLString)
        {
        ...
        public static object GetSingle(string conn, string SQLString)
        {
            using (SqlConnection connection = new SqlConnection(conn))
            {
                using (SqlCommand cmd = new SqlCommand(SQLString, connection))
        ...
        public static int ExecuteSql(string conn, string SQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(conn))
            {
                using (SqlCommand cmd = new SqlCommand())
        ...
        public static bool ExecuteSqlTran(string connection, Hashtable SQLStringList)
        {
        ...
        public static bool ExecuteSqlTrans(string connection, Hashtable SQLStringList)
        {
            using (SqlConnection conn = new SqlConnection(connection))
            {
                conn.Open();
        ...
        public static object GetSingle(string conn, string SQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(conn))
            {
                using (SqlCommand cmd = new SqlCommand())
        ...
        public static DataSet Query(string conn, string SQLString, params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(conn))
            {
                SqlCommand cmd = new SqlCommand();
