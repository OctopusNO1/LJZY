...
namespace LJZY.DBUtility
{
    public class DbHelperOracle
    {
        ...
        public DbHelperOracle(string strConnect, string dataType)
        {
        ...
        public DbHelperOracle()
        {
            ...
            this.connectionString = ConfigurationManager.ConnectionStrings["AccessConn"].ConnectionString;
        ...
        public string DbType
        {
            ...
            set
            {
                ...
                if (dbType == string.Empty || dbType == null)
                {
                    ...
                    dbType = ConfigurationManager.ConnectionStrings["DataType"].ConnectionString;
                }
                if (dbType == string.Empty || dbType == null)
                {
                    dbType = "Access";
