...
namespace LJZY.DBUtility
{
    ...
    public abstract class DbHelperOra
    {
        ...
        public static string connectionString = ConfigurationManager.ConnectionStrings["ORACLEConn"].ConnectionString;
        public DbHelperOra()
        {
        }
        ...
        public static bool ExecuteSqlTrans(ArrayList SQLStringList)
        {
