...
{
    public class LQ_WJKPBLL
    {
        private readonly LQ_WJKPDAO dal;
        public LQ_WJKPBLL()
        {
            dal = new LQ_WJKPDAO();
        }
        ...
        /// <returns></returns>
        //public List<LQ_WJKP> WJKPInfo(int TROW)
        ...
        //    DataTable dt = dal.WJKPInfo(strSql).Tables[0];
        //    int yearsjday = 0;
        //    for (int i = 0; i < dt.Rows.Count; i++)
        //    {
        //        LQ_WJKP model = new LQ_WJKP();
        //        DataRow dr = dt.Rows[i];
        //        model = dal.WJKPModel(dr);
        ...
        //public List<LQ_WJKP> WJKPInfo_BH(string ID)
        //{
        //    LQ_JCZJSON jczlist = new LQ_JCZJSON();
        //    LQ_SGZJSON sgzlist = new LQ_SGZJSON();
        //    LQ_HSEJSON hselist = new LQ_HSEJSON();
        ...
        /// <returns></returns>
        public Dictionary<string, object> WJKPDataGrid(string strWhere, int rows, int page)
        {
            LQ_JCZJSON jczlist = new LQ_JCZJSON();
            LQ_SGZJSON sgzlist = new LQ_SGZJSON();
            LQ_HSEJSON hselist = new LQ_HSEJSON();
            ...
            DataTable dt = dal.WJKP_strWhere(strWhere, rows, page, "AJSJ01_JH DESC ", out recordCount).Tables[0];    // JH ASC，以JH顺序

            // model values, add to list
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                LQ_WJKP model = new LQ_WJKP();
                DataRow dr = dt.Rows[i];
        ...
        /// <returns></returns>
        public DataTable EXCEL_WJKP(string str)
        {
            return dal.EXCEL_WJKP(str).Tables[0];
        }
